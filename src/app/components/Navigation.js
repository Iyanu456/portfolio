  ...
  return (
    ...
    >
      <nav className="flex">
        ...
        <div className={`grid place-items-center md:hidden lg:hidden transition-transform transform duration-300 overflow-y-hidden fixed top-[4.9em] bottom-auto right-0 left-0 z-[1000] h-[100%] w-[80%] bg-[#112240] shadow-lg ${props.mobileMenuOpen ? " translate-x-0" : "translate-x-[180%]"} `}>
